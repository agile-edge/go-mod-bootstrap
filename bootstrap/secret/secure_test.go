...
import (
	...
	mocks2 "github.com/agile-edge/go-mod-secrets/v3/pkg/token/authtokenloader/mocks"
	runtimeTokenMock "github.com/agile-edge/go-mod-secrets/v3/pkg/token/runtimetokenprovider/mocks"
