...
func TestLoadFile(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid - load from HTTP", "http://raw.githubusercontent.com/agile-edge/go-mod-bootstrap/main/bootstrap/config/testdata/configuration.yaml", 4533, "", nil},
		{"Valid - load from HTTPS", "https://raw.githubusercontent.com/agile-edge/go-mod-bootstrap/main/bootstrap/config/testdata/configuration.yaml", 4533, "", nil},
		{"Valid - load from HTTPS with secret", "https://raw.githubusercontent.com/agile-edge/go-mod-bootstrap/main/bootstrap/config/testdata/configuration.yaml?edgexSecretName=mySecretName", 4533, "", map[string]string{"type": "httpheader", "headername": "Authorization", "headercontents": "Basic 1234567890"}},
